                        ...
                        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                            ...
                            <TextField
                                ...
                                {...register('ruc', {
                                    validate: {
                                        isNotEmpty: (value) =>
                                            value.trim() !== '' || 'El RUC es obligatorio y solo puede contener números!',
                                        isExactLength: (value) =>
                                            value.length === 13 || 'El RUC debe tener exactamente 13 dígitos',
                                    },
                                })}
                                value={rucValue} // Mantener sincronización con React Hook Form
                                onChange={(e) => {
                                    const value = e.target.value.replace(/[^0-9]/g, '').slice(0, 13); // Solo números y máximo 13 caracteres
                            ...
                            />
                            <TextField label="Direccion" {...register('direccion')} fullWidth size="small" />
                            <Controller
                                name="logo"
                                control={control}
                                render={({ field }) => (
