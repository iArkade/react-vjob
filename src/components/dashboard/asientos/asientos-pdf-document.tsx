...
export function AsientoPDFDocument({ asiento }: AsientoProps): React.JSX.Element {
     return (
          <Document>
               <Page size="A4" style={styles.page}>
                    ...
                    <View style={[styles.flexRow, { gap: 16 }]}>
                         <View style={[styles.w50, styles.maxTextWidth]}>
                              <Text style={[styles.fontBold, styles.gutterBottom]}>Comentario</Text>
                              <Text>{asiento?.comentario}</Text>
                         </View>
                         <View style={styles.w50}>
                              <Text style={[styles.fontBold, styles.gutterBottom]}>Transacción</Text>
                    ...
                    <View>
                         <View style={styles.items}>
                              ...
                              <View style={styles.itemRow}>
                                   <View style={styles.itemCentro}>
                                        <Text style={[styles.fontSemibold, styles.textCenter]}>Centro</Text>
                                   </View>
                                   <View style={styles.itemCta}>
                                        <Text style={[styles.fontSemibold, styles.textCenter]}>Cta</Text>
                                   </View>
                         ...
                         <View>
                              ...
                              <View style={styles.summaryRow}>
                                   ...
                                   <View style={styles.summaryValue}>
                                        <Text>
                                             {((asiento?.total_debe || 0) - (asiento?.total_haber || 0)).toFixed(2)}
                                        </Text>
                                   </View>
                              </View>
                         </View>
