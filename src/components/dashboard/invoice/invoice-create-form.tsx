                         ...
                         <Stack divider={<Divider />} spacing={4}>
                              <Stack spacing={3}>
                                   ...
                                   <Grid container spacing={3}>
                                        <Grid
                                             sx={{ gridColumn: { xs: 'span 12', md: 'span 6' } }} // Definimos el tamaño de las columnas en el sistema de estilos sx
                                        >
                                             <Controller
                                                  control={control}
                                                  name="customer"
                                        ...
                                        <LocalizationProvider dateAdapter={AdapterDayjs}>  {/* Proveedor de localización */}
                              ...
                              <Grid container spacing={3}>
                                   <Grid
                                        sx={{ gridColumn: { xs: 'span 12', md: 'span 4' } }} // Adaptamos el uso de columnas con sx
                                   >
                                        <Controller
                                             control={control}
                                             name="discount"
